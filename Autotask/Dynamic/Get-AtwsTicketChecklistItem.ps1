...
# Ticket ID
    ...
    [ValidateSet('id', 'Completed', 'CompletedByResourceID', 'CompletedDateTime', 'Important', 'ItemName', 'Position', 'TicketID')]
    [string[]]
    $NotEquals,
    ...
    [ValidateSet('id', 'CompletedByResourceID', 'CompletedDateTime', 'ItemName', 'Position', 'TicketID')]
    [string[]]
    $GreaterThan,
  ...
  dynamicParam {
    $entity = Get-AtwsFieldInfo -Entity TicketChecklistItem -EntityInfo
    $fieldInfo = Get-AtwsFieldInfo -Entity TicketChecklistItem
