...
# Impersonator Creator Resource ID
    ...
    [ValidateSet('id', 'VendorID', 'CreatorResourceID', 'CreateDateTime', 'SubmitDateTime', 'CancelDateTime', 'ShipToName', 'ShipToAddress1', 'ShipToAddress2', 'ShipToCity', 'ShipToState', 'ShipToPostalCode', 'GeneralMemo', 'Phone', 'Fax', 'VendorInvoiceNumber', 'ExternalPONumber', 'PurchaseForAccountID', 'ShippingType', 'ShippingDate', 'Freight', 'LatestEstimatedArrivalDate', 'InternalCurrencyFreight', 'ImpersonatorCreatorResourceID')]
    [string[]]
    $GreaterThan,
  ...
  dynamicParam {
    $entity = Get-AtwsFieldInfo -Entity PurchaseOrder -EntityInfo
    $fieldInfo = Get-AtwsFieldInfo -Entity PurchaseOrder
