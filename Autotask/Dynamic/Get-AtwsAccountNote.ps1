...
# Create Date Time
    ...
    [ValidateSet('AccountID', 'AssignedResourceID', 'CompletedDateTime', 'ContactID', 'EndDateTime', 'id', 'LastModifiedDate', 'Name', 'Note', 'OpportunityID', 'StartDateTime', 'ImpersonatorCreatorResourceID', 'ImpersonatorUpdaterResourceID', 'CreateDateTime')]
    [string[]]
    $NotEquals,
  ...
  dynamicParam {
    $entity = Get-AtwsFieldInfo -Entity AccountNote -EntityInfo
    $fieldInfo = Get-AtwsFieldInfo -Entity AccountNote
