...
# Impersonator Creator Resource ID
    ...
    [ValidateSet('id', 'ParentID', 'Title', 'FullPath', 'AttachDate', 'AttachedByContactID', 'AttachedByResourceID', 'ContentType', 'OpportunityID', 'ImpersonatorCreatorResourceID')]
    [string[]]
    $NotEquals,
    ...
    [ValidateSet('Title', 'FullPath', 'ContentType')]
    [string[]]
    $Like,
  ...
  dynamicParam {
    $entity = Get-AtwsFieldInfo -Entity AttachmentInfo -EntityInfo
    $fieldInfo = Get-AtwsFieldInfo -Entity AttachmentInfo
