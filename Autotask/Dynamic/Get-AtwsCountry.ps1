...
# Invoice Template ID
    ...
    [ValidateSet('id', 'CountryCode', 'Name', 'DisplayName', 'QuoteTemplateID', 'InvoiceTemplateID')]
    [string[]]
    $GreaterThan,
  ...
  dynamicParam {
    $entity = Get-AtwsFieldInfo -Entity Country -EntityInfo
    $fieldInfo = Get-AtwsFieldInfo -Entity Country
