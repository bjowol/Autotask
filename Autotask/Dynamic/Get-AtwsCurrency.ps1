...
# Currency Negative Format
    ...
    [ValidateSet('id', 'Name', 'Description', 'ExchangeRate', 'LastModifiedDateTime', 'UpdateResourceId', 'CurrencyPositiveFormat', 'CurrencyNegativeFormat')]
    [string[]]
    $GreaterThan,
  ...
  dynamicParam {
    $entity = Get-AtwsFieldInfo -Entity Currency -EntityInfo
    $fieldInfo = Get-AtwsFieldInfo -Entity Currency
