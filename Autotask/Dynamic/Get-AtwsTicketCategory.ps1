...
# API Only
    ...
    [ValidateSet('id', 'Name', 'Nickname', 'Active', 'GlobalDefault', 'ApiOnly')]
    [string[]]
    $NotEquals,
  ...
  dynamicParam {
    $entity = Get-AtwsFieldInfo -Entity TicketCategory -EntityInfo
    $fieldInfo = Get-AtwsFieldInfo -Entity TicketCategory
