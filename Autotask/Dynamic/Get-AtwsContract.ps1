...
# Contract Exclusion Set ID
    ...
    [ValidateSet('id', 'AccountID', 'Compliance', 'ContactName', 'ContractName', 'ContractNumber', 'IsDefaultContract', 'Description', 'EndDate', 'EstimatedCost', 'EstimatedHours', 'EstimatedRevenue', 'OverageBillingRate', 'StartDate', 'SetupFee', 'PurchaseOrderNumber', 'OpportunityID', 'RenewedContractID', 'SetupFeeAllocationCodeID', 'ExclusionContractID', 'InternalCurrencyOverageBillingRate', 'InternalCurrencySetupFee', 'ContactID', 'BusinessDivisionSubdivisionID', 'BillToAccountID', 'BillToAccountContactID', 'ContractExclusionSetID', 'UserDefinedField')]
    [string[]]
    $NotEquals,
    ...
    [ValidateSet('id', 'AccountID', 'ContactName', 'ContractName', 'ContractNumber', 'Description', 'EndDate', 'EstimatedCost', 'EstimatedHours', 'EstimatedRevenue', 'OverageBillingRate', 'StartDate', 'SetupFee', 'PurchaseOrderNumber', 'OpportunityID', 'RenewedContractID', 'SetupFeeAllocationCodeID', 'ExclusionContractID', 'InternalCurrencyOverageBillingRate', 'InternalCurrencySetupFee', 'ContactID', 'BusinessDivisionSubdivisionID', 'BillToAccountID', 'BillToAccountContactID', 'ContractExclusionSetID', 'UserDefinedField')]
    [string[]]
    $GreaterThan,
    ...
    [ValidateSet('ContactName', 'ContractName', 'ContractNumber', 'Description', 'PurchaseOrderNumber', 'UserDefinedField')]
    [string[]]
    $Like,
  ...
  dynamicParam {
    $entity = Get-AtwsFieldInfo -Entity Contract -EntityInfo
    $fieldInfo = Get-AtwsFieldInfo -Entity Contract
