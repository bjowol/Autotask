...
# Create Date Time
    ...
    [ValidateSet('CreatorResourceID', 'Description', 'id', 'LastActivityDate', 'TaskID', 'Title', 'ImpersonatorCreatorResourceID', 'ImpersonatorUpdaterResourceID', 'CreateDateTime')]
    [string[]]
    $NotEquals,
  ...
  dynamicParam {
    $entity = Get-AtwsFieldInfo -Entity TaskNote -EntityInfo
    $fieldInfo = Get-AtwsFieldInfo -Entity TaskNote
