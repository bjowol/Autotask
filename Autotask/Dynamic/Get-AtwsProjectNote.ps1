...
# Create Date Time
    ...
    [ValidateSet('CreatorResourceID', 'Description', 'id', 'LastActivityDate', 'ProjectID', 'Title', 'Announce', 'ImpersonatorCreatorResourceID', 'ImpersonatorUpdaterResourceID', 'CreateDateTime')]
    [string[]]
    $NotEquals,
    ...
    [ValidateSet('CreatorResourceID', 'Description', 'id', 'LastActivityDate', 'ProjectID', 'Title', 'ImpersonatorCreatorResourceID', 'ImpersonatorUpdaterResourceID', 'CreateDateTime')]
    [string[]]
    $GreaterThan,
  ...
  dynamicParam {
    $entity = Get-AtwsFieldInfo -Entity ProjectNote -EntityInfo
    $fieldInfo = Get-AtwsFieldInfo -Entity ProjectNote
