...
# Impersonator Creator Resource ID
    ...
    [ValidateSet('Barriers', 'HelpNeeded', 'Market', 'NextStep', 'PromotionName', 'Title', 'WinReasonDetail', 'LossReasonDetail', 'Description')]
    [string[]]
    $Like,
