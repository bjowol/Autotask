    ...
    process { 
        ...
        foreach ($verb in $verbs) {
            ...
            $atwsFunction = New-Object -TypeName PSObject -Property @{
                ...
                Verb                    = $verb
                Parameters              = Get-AtwsParameterDefinition -Entity $Entity -verb $verb -FieldInfo $fieldInfo.where{$_.IsPickList -eq $false}
                DynamicParameters       = $fieldinfo.IsPickList -contains $true
